...
# Add the parent directory or the specific path to sys.path
sys.path.append(os.path.abspath("C:/Users/juanf/OneDrive/Documentos/GitHub/EnergyScope_coupling_GEMMES/EnergyScope-TD"))
